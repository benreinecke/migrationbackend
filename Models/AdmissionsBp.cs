...
public partial class AdmissionsBp
{
    ...
    public string? FamilyNameSecond { get; set; }
    ...
    public string? FaepersonId { get; set; }
    ...
    public string? Referredbydetails { get; set; }

    public string? Ernollmentpacksent { get; set; }

    public string? Enrollmentpackstarted { get; set; }

    public string? Enrollmentpacksubmitted { get; set; }
    ...
    public string? PermissionToTreat { get; set; }
    ...
    public string? AdmissionsNotes { get; set; }
}
