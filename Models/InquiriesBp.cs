...
public partial class InquiriesBp
{
    ...
    public string? InquiryManagement { get; set; }

    public string? ApplicantRating { get; set; }

    public string? ApplicantRatingNotes { get; set; }

    public string? CampusVisitDate { get; set; }
