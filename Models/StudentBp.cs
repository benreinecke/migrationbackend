...
public partial class StudentBp
{
    ...
    public string? PreviousSchoolFromDate { get; set; }

    public string? PreviousSchoolEndDate { get; set; }

    public string? PreviousSchoolNote { get; set; }

    public string? PreviousSchoolGradeCompleted { get; set; }
